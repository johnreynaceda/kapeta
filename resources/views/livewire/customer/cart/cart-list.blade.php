    ...
    <div class="container relative mx-auto space-y-10 px-4 py-8 lg:space-y-10 lg:px-8 lg:py-10 xl:max-w-7xl">
        ...
        <div class="pb-24">
            @forelse ($stores as $key => $item)
                <div class="bg-white border my-3 p-2 px-4 rounded-xl">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div>
                                        <div " class="flex items-center gap-x-2">
                                            <x-button xs wire:click="minusQuantity({{ $order->id }})" icon="minus" />

                                            <span class="bg-red-600 text-white px-3 py-0.5">{{ $order->quantity }}</span>

                                            <x-button wire:click="addQuantity({{ $order->id }})" xs icon="plus" />
                                        </div>
                                    </div>
                                    <span
                                        class="font-medium text-red-600">&#8369;{{ number_format($order->product->price * $order->quantity, 2) }}</span>
                                    {{-- <span
                                    ...
                                    <div x-data="{ title: 'Sure Delete?' }">
                                        <x-button label="delete" xs flat negative icon="trash"
                                        x-on:confirm="{
                                            title,
                                            icon: 'error',
...
@empty
 @endforelse
                                            <div class="flex border-t justify-end">
                                                <span class="font-medium mt-1">Subtotal:
                                                    &#8369;{{ number_format(
                                ...
                                @empty
                                    <div class="grid place-content-center">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="h-56"
                                            ...
                                            <path
                                                ...
                                                transform="translate(-152 -76.01429)" fill="#dc2626" />
                                            <rect x="413.2485" y="35.90779" width="140" height="2"
                                                fill="#f2f2f2" />
                                            <rect x="513.2485" y="37.40779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                            <rect x="452.2485" y="37.40779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                            <rect x="484.2485" y="131.90779" width="140" height="2"
                                                fill="#f2f2f2" />
                                            <rect x="522.2485" y="113.90779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                            <rect x="583.2485" y="113.90779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                            <rect x="670.2485" y="176.90779" width="140" height="2"
                                                fill="#f2f2f2" />
                                            <rect x="708.2485" y="158.90779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                            <rect x="769.2485" y="158.90779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                            ...
                                            <rect x="51.2485" y="254.40779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                            <rect x="180.2485" y="152.90779" width="140" height="2"
                                                fill="#f2f2f2" />
                                            <rect x="218.2485" y="134.90779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                            <rect x="279.2485" y="134.90779" width="2" height="18.5"
                                                fill="#f2f2f2" />
                                        </svg>
                                        <div class="mt-3 text-center">
                                            <span class="text-xl  text-gray-500">EMPTY BASKET !</span>
                                        </div>
                                    </div>
                        @endforelse
                    ...
                    <div
                        class="fixed z-50 bottom-0 left-0 right-0  border rounded-t-xl  mx-auto space-y-10 px-4 py-8 lg:space-y-10 lg:px-8 lg:py-10 xl:max-w-7xl">
                        <div class="flex space-x-4 items-center justify-end">
                            ...
                            <x-button negative rounded label="CHECKOUT" href="{{ route('customer.checkout') }}"

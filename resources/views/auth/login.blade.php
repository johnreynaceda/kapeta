    ...
    <div class="min-h-screen relative">
        ...
        <section class="relative overflow-hidden ">
            <div class="relative w-full mx-auto max-w-7xl">
                <div class="mb-10 text-transparent">
                    dsd
                </div>
            </div>
        </section>
        <section class="relative flex items-center w-full  ">
            <div class="relative items-center w-full px-5 py-24 mx-auto lg:px-16 lg:py-36 max-w-7xl md:px-12">
                <div class="relative flex-col items-start m-auto align-middle">
                    <div class="grid grid-cols-1 gap-6 lg:gap-20 lg:grid-cols-2">
                        <div class="relative  items-center gap-12 mx-2 lg:inline-flex">
                              ...
                              <span class="ml-3">Add to Chrome</span></a> --}}
                                    <div class="w-full">
                                        ...
                                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                                            ...
                                            <div>
                                                <label for="email"
                                                    class="block text-sm font-medium leading-6 text-gray-600">Email
                                                    address</label>
                                                <div class="mt-2">
                                            ...
                                            <div>
                                                <label for="password"
                                                    class="block text-sm font-medium leading-6 text-gray-600">Password</label>
                                                <div class="mt-2">
                                                    <x-inputs.password icon="key" id="password" type="password"
                                            ...
                                            <div>
                                                <button>
                                                    <x-button type="submit" label="Sign In" class=" font-bold w-full"
                                                        negative rounded right-icon="login" />
                                                </button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="block w-full mt-12 lg:mt-0">
                            {{-- <img alt="hero"
                                ...
                                src="https://images.unsplash.com/photo-1606791405792-1004f1718d0c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80"> --}}

                            <div class=" grid place-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="h-96"
                                    viewBox="0 0 842 842.79999" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <path
                                    ...
                                    <circle cx="615.88796" cy="247.04501" r="39.26025"
                                        transform="translate(-173.29779 479.25635) rotate(-45)" fill="#9e616a" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-179 -28.60001)" fill="#d80a16" />
                                    <path
                            ...
                            <div class="mt-4 text-center text-3xl font-titan text-red-600">
                                KAPETA!
                            </div>
                        </div>
                    </div>

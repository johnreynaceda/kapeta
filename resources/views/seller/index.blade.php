<x-admin-layout>
    <div class="container mx-auto space-y-10 px-4 py-8 lg:space-y-16 lg:px-8 lg:py-10 xl:max-w-7xl">
        <!-- Latest Movies -->
        <section class=" flex space-x-4">
            <div class=" p-4 border py-3 rounded-lg w-64 relative overflow-hidden shadow">
        ...
        <section class="space-y-6">
            <div class="flex items-center justify-between">
                ...
                <a href="javascript:void(0)"
                    class="group flex items-center space-x-1 text-sm text-slate-400 transition hover:text-white active:text-slate-400">
                    <span>See All</span>
            ...
            <nav class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                <!-- Movie -->
                <a href="javascript:void(0)"
                    class="aspect-w-16 aspect-h-10 group relative overflow-hidden rounded-2xl bg-black/25 transition hover:ring-4 hover:ring-red-600 active:opacity-75 active:ring-indigo-500/25">
                    ...
                    <div
                        ...
                        <div class="flex items-end justify-between space-x-2 px-4 py-5">
                            <div class="space-y-1">
                                ...
                                <p class="text-sm font-semibold text-slate-400">&#8369;150.00</p>
                            </div>
                            <div
                ...
                <!-- Movie -->
                <a href="javascript:void(0)"
                    class="aspect-w-16 aspect-h-10 group relative overflow-hidden rounded-2xl bg-black/25 transition hover:ring-4 hover:ring-red-600 active:opacity-75">
                    <img class="object-cover"
                        src="https://plus.unsplash.com/premium_photo-1669374537636-518629de3b85?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" />
                    <div
                        class="absolute inset-0 flex flex-col justify-between bg-gradient-to-b from-transparent via-black/75 to-black">
                        <div class="flex items-center justify-start space-x-2 p-4">
                            <div
                        ...
                        <div class="flex items-end justify-between space-x-2 px-4 py-5">
                            <div class="space-y-1">
                                ...
                                <p class="text-sm font-semibold text-slate-500">&#8369;135.00</p>
                            </div>
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-500/25 text-slate-400 fill-white transition group-hover:scale-110 group-hover:bg-red-600 group-hover:text-white group-active:scale-100">
                                {{-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                ...
                <a href="javascript:void(0)"
                    ...
                    <div
                        ...
                        <div class="flex items-end justify-between space-x-2 px-4 py-5">
                            ...
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-500/25 text-slate-400 fill-white transition-all group-hover:scale-110 group-hover:bg-red-600 group-hover:text-white group-active:scale-100">
                                {{-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="hi-mini hi-play h-5 w-5 translate-x-0.5">
                                    <path
                                        d="M6.3 2.841A1.5 1.5 0 004 4.11V15.89a1.5 1.5 0 002.3 1.269l9.344-5.89a1.5 1.5 0 000-2.538L6.3 2.84z" />
